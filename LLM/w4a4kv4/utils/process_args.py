...
def parser_gen():
    ...
    parser.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Whether to enable activation quantization during GPTQ (default: False)",
    )
    # LM Eval Arguments
    ...
    parser.add_argument('--lm_eval_batch_size', type=int, default=2, help='Batch size for evaluating with lm eval harness.')
